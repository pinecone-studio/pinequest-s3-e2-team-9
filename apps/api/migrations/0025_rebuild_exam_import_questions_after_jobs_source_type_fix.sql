...
ALTER TABLE exam_import_questions RENAME TO exam_import_questions_old_source_type_fix;
...
SELECT
  ...
  needs_review,
  created_at
FROM exam_import_questions_old_source_type_fix;

DROP TABLE exam_import_questions_old_source_type_fix;
