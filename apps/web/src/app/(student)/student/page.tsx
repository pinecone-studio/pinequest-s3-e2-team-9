  ...
  return (
    <RoleGuard allowedRoles={["STUDENT"]}>
      <main className="min-h-screen bg-[#FCF8F3] px-6 py-10 sm:px-10 lg:px-16">
        <section className="mx-auto max-w-4xl rounded-[32px] border border-[#E4D8C8] bg-white p-8 shadow-[0_20px_60px_rgba(16,24,40,0.08)]">
          ...
          <p className="mt-3 max-w-2xl text-[16px] leading-7 text-[#475467]">
            Одоогоор student workflow хэрэгжээгүй байгаа ч route болон хөгжүүлэлтийн эхлэх цэгийг тусад нь гаргасан.
            Цаашдын exam list, attempt, result page-ууд энэ хэсэгт байрлана.
          </p>
