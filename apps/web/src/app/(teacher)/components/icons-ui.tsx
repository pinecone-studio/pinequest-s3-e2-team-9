...
export function ClassManagementIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        fill="#F5F5F5"
        d="M8 4.5c1.087 0 2.047.26 2.827.6A1.99 1.99 0 0 1 12 6.92V8H4V6.927c0-.787.453-1.507 1.173-1.82A6.96 6.96 0 0 1 8 4.5Zm-5.333.167C3.4 4.667 4 4.067 4 3.333 4 2.6 3.4 2 2.667 2c-.734 0-1.334.6-1.334 1.333 0 .734.6 1.334 1.334 1.334Zm.753.733a4.655 4.655 0 0 0-.753-.067c-.66 0-1.287.14-1.854.387A1.34 1.34 0 0 0 0 6.953V8h3V6.927A3 3 0 0 1 3.42 5.4Zm9.913-.733c.734 0 1.334-.6 1.334-1.334 0-.733-.6-1.333-1.334-1.333C12.6 2 12 2.6 12 3.333c0 .734.6 1.334 1.333 1.334ZM16 6.953c0-.54-.32-1.02-.813-1.233a4.634 4.634 0 0 0-1.854-.387c-.26 0-.506.027-.753.067.267.453.42.973.42 1.527V8h3V6.953ZM8 0c1.107 0 2 .893 2 2s-.893 2-2 2-2-.893-2-2 .893-2 2-2Z"
      />
    </svg>
  );
}
