...
export function AppShell({
  ...
  const heightClasses = fixedHeight ? "lg:h-[900px] lg:overflow-hidden" : "min-h-screen";
  ...
  return (
    <main className={`bg-[#FAFAFA] w-full ${heightClasses}`.trim()}>
      <div className={`flex flex-col lg:flex-row ${fixedHeight ? "lg:h-[900px]" : "min-h-screen"}`.trim()}>
        <Sidebar />
        <section className={`flex-1 ${contentOverflowClass} ${fixedHeight ? "lg:h-[900px]" : ""}`.trim()}>
          <div
            className={[
