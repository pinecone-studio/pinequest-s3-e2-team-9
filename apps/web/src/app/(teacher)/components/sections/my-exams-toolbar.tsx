        ...
        {isLibraryMode ? (
          <div className="flex items-center justify-between gap-3 xl:justify-end">
            ...
            <button
              ...
              className="inline-flex h-11 items-center justify-center rounded-full border border-[#D0D5DD] bg-white px-5 text-[14px] font-medium leading-5 text-[#0F1216] shadow-[0px_1px_2px_rgba(16,24,40,0.05)] transition hover:bg-[#F9FAFB]"
            >
              PDF upload
            </button>
            <Link
