    ...
    <section className="space-y-3">
      ...
      <div className="rounded-xl border border-[#E4E7EC] bg-white p-8 shadow-card">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[14px] text-[#667085]">
              <span className="flex items-center gap-2">
                ...
                Математик 101- А бүлэг
              </span>
              <span className="flex items-center gap-2">
                <ClockIcon className="h-4 w-4 text-[#52555B]" />2 жилийн
                турш ашиглагдаж байна
              </span>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-lg bg-[#FAFAFA99] px-4 py-3 text-center">
            <div className="text-[20px] font-semibold text-[#101828]">22</div>
            <p className="mt-1 text-[12px] text-[#667085]">Илгээсэн</p>
          </div>
          <div className="rounded-lg bg-[#FAFAFA99] px-4 py-3 text-center">
            <div className="text-[20px] font-semibold text-[#D92D20]">1</div>
            <p className="mt-1 text-[12px] text-[#667085]">
              Сэжигтэй үйлдэл
            </p>
          </div>
        ...
        <div className="mt-5 space-y-2">
          <div className="flex items-center justify-between text-[12px] text-[#344054]">
            ...
            <span className="font-medium text-[#667085]">550%</span>
          </div>
          <div className="h-2 rounded-full bg-[#19223033]">
            <div className="h-full w-full rounded-full bg-[#00267F]" />
          </div>
        </div>
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <button className="flex min-w-[160px] items-center justify-center gap-2 rounded-md bg-[#D92D20] px-3 py-2 text-[14px] font-medium text-white">
